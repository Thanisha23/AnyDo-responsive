...
const Header = ({selection}) => {
  ...
  return (
    <div className={`container header text-center ${classExtra}`}>
      <div className="logo text-4xl md:text-7xl font-crisis">AnyDo:&gt;</div>
     

      <div
        className="header-1 pt-6 md:mb-6 relative inline-flex items-center justify-center w-[100]"
      >
...
>
  Organize your day with ease: your personal to-do app
      ...
      <div
        className="header-2 flex flex-col justify-center items-center font-mono h-32"
      >
      ...
      <div
        className="buttons pt-4 mb-6 mr-5 relative inline-flex items-center justify-center"
      >
